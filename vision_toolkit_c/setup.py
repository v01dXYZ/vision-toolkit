...
pkgs = [
        "vision_toolkit.segmentation.segmentation_algorithms.c_I_DeT",
        "vision_toolkit.segmentation.segmentation_algorithms.c_I_HMM",
        "vision_toolkit.scanpath.similarity.c_comparison_algorithms",
        "vision_toolkit.aoi.common_subsequence.local_alignment.c_alignment_algorithms",
        "vision_toolkit.aoi.markov_based.c_HMM",
]
ext_modules = [
    Extension(
