...
| `Zemblys`      | Viewers look at a target moving on different points on a screen chosen randomly.) |  [replication report](https://github.com/r-zemblys/irf/blob/master/doc/IRF_replication_report.pdf)                                                                                                                       | yes |   OK (Segmentation)   |
