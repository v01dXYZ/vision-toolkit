...
class ConfigMixin:
    ...
    def __getitem__(self, key: str):
        """
        Support indexing syntax: config["key"]

        This provides a dictionary-like interface while maintaining
        the dataclass structure. Missing keys return None.
    ...
    def __setitem__(self, key: str, value):
        """
        Support item assignment: config["key"] = value
        ...
        if hasattr(self, "__dataclass_fields__") and key in self.__dataclass_fields__:
            ...
            raise KeyError(f"Config has no field '{key}'")
    ...
    def __contains__(self, key: str) -> bool:
        ...
        """
        return (
            hasattr(self, "__dataclass_fields__")
            and key in self.__dataclass_fields__
    ...
    def get(self, key: str, default=None):
        ...
        Args:
            key: The config field name
            default: Value to return if key not found or is None

        Returns:
            The value of the field, or default if not found/None
        """
