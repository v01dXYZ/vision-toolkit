...
def get_cli_args():
    ...
    arg_parser.add_argument("-d", "--directory", help=f"{default_directory_root}/<test_name>", type=pathlib.Path)

    args = arg_parser.parse_args()

    if args.directory is None:
        args.directory = pathlib.Path(default_directory_root) / args.test_name
